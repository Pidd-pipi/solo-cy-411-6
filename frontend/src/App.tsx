...
import { AuditOutlined, ApartmentOutlined, BarChartOutlined, FlagOutlined, LogoutOutlined, OrderedListOutlined, TeamOutlined, UserOutlined } from '@ant-design/icons';
...
const navItems = [
  ...
  { key: '/organization', icon: <ApartmentOutlined />, label: '组织' },
